    ...
    return StreamBuilder<List<ChatRecord>>(
      stream: queryChatRecord(
        queryBuilder: (chatRecord) => chatRecord
            ...
            .where(
              'secondaryUserId',
              isEqualTo: widget.secondaryUserId,
            ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<ChatRecord> messageChatRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final messageChatRecord = messageChatRecordList.isNotEmpty
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await MessageRecord.createDoc(
                                      messageChatRecord!.reference)
                                  .set({
                                ...createMessageRecordData(
                                  sender: messageChatRecord.primaryUserId,
