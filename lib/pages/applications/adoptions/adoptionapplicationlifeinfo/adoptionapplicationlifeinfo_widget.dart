...
import 'adoptionapplicationlifeinfo_model.dart';
export 'adoptionapplicationlifeinfo_model.dart';

class AdoptionapplicationlifeinfoWidget extends StatefulWidget {
  const AdoptionapplicationlifeinfoWidget({super.key});

  static String routeName = 'adoptionapplicationlifeinfo';
  static String routePath = '/adoptionapplicationlifeinfo';

  @override
  State<AdoptionapplicationlifeinfoWidget> createState() =>
      _AdoptionapplicationlifeinfoWidgetState();
}

class _AdoptionapplicationlifeinfoWidgetState
    extends State<AdoptionapplicationlifeinfoWidget> {
  late AdoptionapplicationlifeinfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdoptionapplicationlifeinfoModel());
                                    ...
                                    children: [
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 16.0, 16.0, 0.0),
                                            child: Text(
                                              'If your Lucky Dog is not currently house trained, how long do you foresee it taking to house train your new companion? (NOTE: All dogs have accidents and need to learn a new schedule when entering a new environment, even if considered house trained at the rescue.)\n',
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed(
                                                AdoptionapplicationhomeinfoWidget
                                                    .routeName);
                                          },
                                          text: 'Next',
