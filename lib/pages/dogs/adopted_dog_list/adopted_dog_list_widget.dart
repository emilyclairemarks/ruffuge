...
import 'adopted_dog_list_model.dart';
export 'adopted_dog_list_model.dart';

class AdoptedDogListWidget extends StatefulWidget {
  const AdoptedDogListWidget({super.key});

  static String routeName = 'AdoptedDogList';
  static String routePath = '/AdoptedDogList';

  @override
  State<AdoptedDogListWidget> createState() => _AdoptedDogListWidgetState();
}

class _AdoptedDogListWidgetState extends State<AdoptedDogListWidget> {
  late AdoptedDogListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdoptedDogListModel());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/Account_Creation_page.jpg',
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(4.0),
                                        child: Image.asset(
                                          'assets/images/Shelter_Dog_5.jpg',
                                          width: double.infinity,
                                          height: 200.0,
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(4.0),
                                        child: Image.asset(
                                          'assets/images/Shelter_Dog_1.jpg',
                                          width: double.infinity,
                                          height: 200.0,
                                          fit: BoxFit.scaleDown,
                                        ),
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(4.0),
                                        child: Image.asset(
                                          'assets/images/Shelter_Dog_4.jpg',
                                          width: double.infinity,
                                          height: 200.0,
                                          fit: BoxFit.scaleDown,
                                        ),
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(4.0),
                                        child: Image.asset(
                                          'assets/images/Shelter_Dog_3.jpg',
                                          width: double.infinity,
                                          height: 200.0,
                                          fit: BoxFit.scaleDown,
                                        ),
