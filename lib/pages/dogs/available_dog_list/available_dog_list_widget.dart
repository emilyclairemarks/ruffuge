...
import 'available_dog_list_model.dart';
export 'available_dog_list_model.dart';

class AvailableDogListWidget extends StatefulWidget {
  const AvailableDogListWidget({super.key});

  static String routeName = 'AvailableDogList';
  static String routePath = '/availableDogList';

  @override
  State<AvailableDogListWidget> createState() => _AvailableDogListWidgetState();
}

class _AvailableDogListWidgetState extends State<AvailableDogListWidget> {
  late AvailableDogListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AvailableDogListModel());
